...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="home">
			<img src="resources/images/icon_home.png" width="20" height="20" />系统设置&nbsp;>&nbsp;公司管理
		</div>
		<div class="m_w">
			<!--检索部分-->
			<div class="tab_check" style="min-width: 850px;">
				<s:form action="govunit!view" namespace="/admin" id="base_frm" style="float:left;">
					<s:textfield name="unit.unitName" cssClass="auto_tips" alt="请输入公司名称" style="float:left; width:150px;border:1px solid #aaa;height:28px;padding:1px 5px;line-height:28px"></s:textfield>
				...
				<input type="button" value="新增分公司" class="btn_search" style="margin-left:10px;margin-top:-3px;" onclick="location.href='admin/govunit!add'" />
				
				<s:if test="1 == #session.userinfo_in_session.roleId || 11 == #session.userinfo_in_session.roleId">
				  <input type="button" value="市级分公司管理" class="btn_search" style="margin-left:10px;margin-top:-3px;" onclick="location.href='admin/area'" />
			    </s:if>
			</div>
			<!--表格-->
