...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function select_province(id,name){
				$(".tab1:eq(1) tr:eq(0) th:eq(0)").text(name + ' 市级分公司列表');
	...
	<body>
		...
		<div class="m_w">
			<!--检索部分-->
			<div class="tab_check">
				<input type="button" value="返回公司管理" class="btn_search" style="margin-left:10px;" onclick="location.href='admin/govunit!view'" />
