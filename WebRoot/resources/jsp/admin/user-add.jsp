		 ...
		 <s:form id="user_form" action="user!save" namespace="/admin" method="post">
			 ...
			 <div class="hid_files_div">
					...
					<table width="60%" border="0" cellspacing="0" cellpadding="0" class="tab_1" style="margin:40px 0 0 40px;float:left;">
						...
						<tr id="city">
						    <td align="right">市级公司：</td>
						    <td>
						       <s:if test="null == #session.userinfo_in_session.cityInfo">
								  <label for="number"></label>
								  <s:select id="cityList" headerKey="" headerValue="请选择市级公司" list="cityList" name="user.cityId" listKey="id" listValue="cityName" cssClass="sel_02 validate[required]" />
							   </s:if>
							   <s:else>
						  ...
						  <tr id="unit">
						    ...
						    <td>
								<label for="number"></label>
								<s:select id="unitList" headerKey="" headerValue="请选择公司" list="unitList" name="user.unitId" listKey="id" listValue="unitName" cssClass="sel_02" />
							</td> 
						  </tr>
						<tr>
							<td align="right">
